...
<div class="container" style="min-height: 800px;">
  ...
  <p>
    ...
    <ul>
      <li style="color: #4f5c6d">The latest stable version for Raspbian can be found <a href="http://www.eclipse.org/downloads/download.php?file=/kura/releases/0.7.1/kura-raspberry-pi_0.7.1_armv6.deb" target="_blank">here</a></li>
      ...
      <li style="color: #4f5c6d">The latest stable version for the BeagleBone Black rev C with Debian can be found <a href="http://www.eclipse.org/downloads/download.php?file=/kura/releases/0.7.1/kura-beaglebone_debian_0.7.1_armv7.deb" target="_blank">here</a></li></li>
    ...
    <ul>
      <li style="color: #4f5c6d">The latest stable version for Raspbian can be found <a href="https://s3.amazonaws.com/kura_downloads/raspbian/release/kura-raspberry-pi_0.7.1_armv6.deb" target="_blank">here</a></li>
      <li style="color: #4f5c6d">The latest stable version for the BeagleBone Black rev C with Debian can be found <a href="https://s3.amazonaws.com/kura_downloads/debian/release/kura-beaglebone_debian_0.7.1_armv7.deb" target="_blank">here</a></li>
    </ul>
  ...
  <p>
    ...
    <ul>
        <li style="color: #4f5c6d">A Kura workspace. This is all the necessary jar files and APIs needed to build an application with Kura. Simply import the archive into an Eclipse workspace and start coding.
          Download the archive from <a href="http://www.eclipse.org/downloads/download.php?file=/kura/releases/0.7.1/user_workspace_archive_0.7.1.zip" target="_blank">here</a></li>
        <li style="color: #4f5c6d">The Raspberry jars. If you want to manually instally Kura on your Raspberry, grab the archive of Kura
           <a href="http://www.eclipse.org/downloads/download.php?file=/kura/releases/0.7.1/kura-raspberry-pi-jars_0.7.1.zip" target="_blank">here</a></li>
    </ul>
  </p>
</div>
